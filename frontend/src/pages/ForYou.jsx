  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      try {
        ...
        console.log('📡 [ForYou] Fetching recommendations from:', `${API_URL}/api/recommendations/`);
        ...
        console.log('📥 [ForYou] Response status:', response.status, response.ok ? '✅' : '❌');
        ...
        console.log('📚 [ForYou] Recommendations count:', data.recommendations?.length || 0);
        console.log('👤 [ForYou] Has preferences:', data.has_preferences);
        ...
        console.error("❌ [ForYou] Error fetching recommendations:", err);
