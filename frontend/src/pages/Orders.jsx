                        ...
                        return (
                          <div key={item.id} className="flex flex-col border border-brand-secondary rounded-lg overflow-hidden">
                            ...
                            {order.status === 'CHECKED_OUT' && item.due_at && remainingDays !== null && (
                              <div className="px-4 py-2 text-sm font-bold border-t bg-brand-light text-brand-secondary">
                  ...
                  {order.status === 'REQUESTED' && (
                    <div className="flex justify-end pt-4">
                      <button
                        ...
                        className={`font-semibold py-2 px-6 rounded-lg shadow-sm transition duration-200 text-brand-light ${cancellingId === order.id ? 'bg-brand-primary opacity-70 cursor-not-allowed' : 'bg-brand-primary hover:bg-brand-primary'}`}
                      >
