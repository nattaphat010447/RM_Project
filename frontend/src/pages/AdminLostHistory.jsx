...
const AdminHistory = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-light p-4 md:p-10 flex justify-center items-start pt-16">
      <div className="bg-brand-light rounded-3xl shadow-xl w-full max-w-6xl p-8 md:p-10 relative">
        
        <div className="flex justify-between items-center mb-6">
          <button onClick={() => navigate(-1)} className="text-brand-primary hover:text-brand-primary transition duration-200">
          ...
          <h1 className="text-2xl md:text-3xl font-black text-brand-primary">Rental History</h1>
          
          <button onClick={() => { localStorage.removeItem('access_token'); navigate('/signin'); }} className="text-brand-primary hover:text-brand-secondary transition duration-200">
        ...
        <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-brand-secondary rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent text-sm transition-shadow"
            />
            {searchQuery && (
              <button 
